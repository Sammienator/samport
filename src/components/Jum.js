...
const Jum = () => {
  return (
    <div id='homee' className='backg'>
        <div class="container-fluid p-5" style={{"textAlign": "center" ,  "fontWeight": "bolder" }}>
        
	  <h1 class="display-4">Samuel Mugo: Portfolio</h1>
	  <p style={{color: "white", fontSize
    : "50px", fontWeight : "bolder",
    }} class="lead">Junior Software Developer.</p>
	  <hr class="my-4" />
	  <p style={{fontSize: "30px", text: "FFC300"}}> I am a responsible, self-motivated person, greatly expereienced from working in diverse
	  ...
	  <a  href="#contactt" role="button"> <h1> 
      <button style={{backgroundColor
      : "#FFC300"}}> Hire ME </button> </h1> </a>
</div>
    </div>
  )
}
